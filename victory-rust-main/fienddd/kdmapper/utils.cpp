...
bool EYE::ReadFileToMemory(const std::string& file_path, std::vector<uint8_t>* out_buffer)
{
...
bool EYE::CreateFileFromMemory(const std::string& desired_file_path, const char* address, size_t size)
{
...
uint64_t EYE::GetKernelModuleAddress(const std::string& module_name)
{
	void* buffer = nullptr;
	DWORD buffer_size = 0;
